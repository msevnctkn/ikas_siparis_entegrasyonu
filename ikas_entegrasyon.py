    ...
    def siparis_dataframe_hazirla(self, data):
      ...
      for content in self.siparis_bilgileri:
        ...
        try:
          ...
          #sonuc = self.resmi_tatil.is_gunu_ekle(siparis_tarihi,12)
          #st.write("tarih:", siparis_tarihi,)
          ...
          imalat_bitis_suresi = pd.to_datetime(self.resmi_tatil.is_gunu_ekle(tarih_str=siparis_tarihi, is_gunu=12), dayfirst=True).date().strftime("%d.%m.%y")
